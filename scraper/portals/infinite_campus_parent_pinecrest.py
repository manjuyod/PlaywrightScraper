...
class InfiniteCampus(PortalEngine):
    ...
    LOGIN = "https://nspcsa.infinitecampus.org/campus/portal/parents/pinecrest.jsp"
    GRADEBOOK = (
        "https://nspcsa.infinitecampus.org/campus/nav-wrapper/parent/portal/parent/grades?appName=pinecrest"
    )
    LOGOFF = "https://nspcsa.infinitecampus.org/campus/portal/parents/pinecrest.jsp?status=logoff"
