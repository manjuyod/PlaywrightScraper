...
from . import infinite_campus_student_ccsd, infinite_campus_parent_ccsd, infinite_campus_parent_gilbert, infinite_campus_parent_alac, parentvue_husd, powerschool_lts_parent, studentvue_husd, infinite_campus_student_chandler