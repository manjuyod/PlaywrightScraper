...
otherwise an old process can write the retired shared columns after backfill.
Deploy the matching Python, executable, and dashboard together, verify `doctor`
and pilot jobs, then apply the shared-state cleanup migration.
